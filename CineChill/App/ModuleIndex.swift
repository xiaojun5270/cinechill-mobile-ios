...
public enum ModuleIndex {
    ...
    private static let libraryItems: [ModuleEntry] = [
        ...
        ModuleEntry(id: "EmbyTasksView", title: "Emby 任务中心", group: "Emby", tab: .library,
    ...
    private static let automationItems: [ModuleEntry] = [
        ModuleEntry(id: "RSSView", title: "RSS 订阅", group: "RSS", tab: .automation,
                    systemImage: "dot.radiowaves.up.forward", tint: .orange,
                    keywords: "rss 订阅 feed 抓取 /api/rss") { AnyView(RSSView()) },
        ...
        ModuleEntry(id: "MoviePilotSitesView", title: "MoviePilot 站点管理", group: "订阅", tab: .automation,
        ...
        ModuleEntry(id: "Upload115View", title: "115 上传", group: "115 网盘", tab: .automation,
        ...
        ModuleEntry(id: "Cloud115RapidView", title: "云端秒传", group: "115 网盘", tab: .automation,
        ...
        ModuleEntry(id: "DockerView", title: "Docker", group: "Docker", tab: .automation,
    ...
    private static let settingsItems: [ModuleEntry] = [
        ModuleEntry(id: "AccountView", title: "账号", group: "账号与服务器", tab: .settings,
        ...
        ModuleEntry(id: "ServerRawConfigView", title: "服务端原始配置", group: "服务端", tab: .settings,
                    systemImage: "curlybraces", tint: .gray,
                    keywords: "raw json 原始 配置 高级") { AnyView(ServerRawConfigView()) },
        ModuleEntry(id: "Config302View", title: "302 与网盘", group: "302 与网盘", tab: .settings,
                    systemImage: "arrow.uturn.forward.circle", tint: .teal,
                    keywords: "302 重定向 网盘 cookie 直链 /api/config_302") { AnyView(Config302View()) },
        ModuleEntry(id: "Config302RawView", title: "302 原始配置", group: "302 与网盘", tab: .settings,
                    systemImage: "curlybraces.square", tint: .gray,
                    keywords: "302 raw json 原始") { AnyView(Config302RawView()) },
        ...
        ModuleEntry(id: "NotifyView", title: "通知渠道", group: "通知", tab: .settings,
        ...
        ModuleEntry(id: "AIAssistantView", title: "AI 助手", group: "AI 助手", tab: .settings,
        ...
        ModuleEntry(id: "AppearanceView", title: "外观", group: "应用", tab: .settings,
                    systemImage: "paintbrush.pointed", tint: .indigo,
                    keywords: "appearance 外观 液态玻璃 liquid glass 导航栏 材质") { AnyView(AppearanceView()) },

...
public enum ModuleIndex {
    ...
    private static let systemItems: [ModuleEntry] = [
        ModuleEntry(id: "TaskCenterView", title: "自动封面", group: "系统", tab: .dashboard,
